...
class Validator:
    ...
    def validate_schema_file(
        cls, path: str | Path, file_hash: str | None
        ...
        return cls.validate_schema(data, file_path=path_str)

    @classmethod
    def validate_schema(
        cls, data: dict, file_path: str | None = None
    ) -> ValidationOutputSchema:
                ...
                "errors": [
                    {
                        ...
                        "error_at": Validator.__format_loc_as_jsonql(error),
                        "message": Validator.__format_pydantic_error_as_text(error),
                        "pydantic_error": Validator.__strip_details(error),
                    }
    ...
    @classmethod
    def __strip_details(cls, error: ErrorDetails) -> PydanticErrorSchema:
    ...
    @classmethod
    def __format_loc_as_jsonql(cls, error: ErrorDetails) -> str:
    ...
    @classmethod
    def __format_pydantic_error_as_text(cls, error: ErrorDetails) -> str:
        ...
        match error["type"]:
            case "extra_forbidden":
                ...
                error_string = (
                    f"'{loc_minus_1}' invalid attribute for '{loc_minus_2}' type"
                )
            case "missing":
                loc_minus_1 = error["loc"][-1]
